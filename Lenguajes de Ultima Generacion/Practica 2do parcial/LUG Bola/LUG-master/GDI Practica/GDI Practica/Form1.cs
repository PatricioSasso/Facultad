...
namespace GDI_Practica
{
    public partial class Form1 : Form
    {
        ...
        {
            //cargo el grid con la lista proveniente del GN Generador de Numeros
            int n = 0;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            GN.GraficarTorta(this,Contador,groupBox1);
        }
    ...
    public class GeneradorNumeros
    {
        ...
        public void GraficarTorta(Form formulario,int tiradas, GroupBox b)
        {

            Graphics GX = formulario.CreateGraphics();
            ...
            foreach (VistaNumeros vn in LVN)
            {
                if (vn.Apariciones != 0)// este if es por si la aparicion es 0 y rompe todo porque divide por 0
                {
                    ...
                    double porcion = Math.Round((a * 360), 6);// lo de arriba por 360

                    G.FillPie(vn.SB, 0, 5, 300, 300, desde, (float)porcion);//fillpie pide color que esta guardado en la vista x y w h desde donde va a graficar y cuanto
